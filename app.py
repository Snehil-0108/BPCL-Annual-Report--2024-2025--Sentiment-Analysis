# ============================================================
# 📘 BPCL Annual Report Analyzer (Streamlit)
# ============================================================
...
def local_css():
    st.markdown("""
        ...
        .card {background-color:#fff; border-radius:10px; border:1px solid #dce3f0; padding:1.6rem; margin-bottom:1.2rem; box-shadow:0 4px 8px rgba(0,0,0,0.04);}
...
# ---------------------- HELPERS --------------------------
@st.cache_data
def load_and_extract_text(pdf_file):
...
def main():
    ...
    uploaded_file = st.sidebar.file_uploader("📄 Upload BPCL Annual Report (PDF)", type=["pdf"])
